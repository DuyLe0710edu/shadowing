...
# Disable GPU for EasyOCR on Apple Silicon due to MPS compatibility issues
# Use CPU mode which is fast and stable on M3 Pro
GPU_AVAILABLE = torch.cuda.is_available()  # Only enable for NVIDIA CUDA
