...
export class TranslationCache {
  ...
  private readonly maxAge: number = 24 * 60 * 60 * 1000 // 24 hours in milliseconds
   ...
   */
  private generateKey(text: string, sourceLang: string = 'auto', targetLang: string = 'en'): string {
   ...
   */
  public get(text: string, sourceLang: string = 'auto', targetLang: string = 'en'): CacheEntry | null {
   ...
   */
  public set(text: string, result: TranslationResult, sourceLang: string = 'auto', targetLang: string = 'en'): void {
    const key = this.generateKey(text, sourceLang, targetLang)
   ...
   */
  public getPopularTranslations(limit: number = 10): Array<{ text: string, entry: CacheEntry }> {
   ...
   */
  public preloadCommonTranslations(): void {
    const commonPhrases = [
    ...
    commonPhrases.forEach(({ text, result }) => {
      this.set(text, result as TranslationResult)
    })
